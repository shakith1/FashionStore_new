...
import image from "../../images/istock-639223110-3.jpg";
...
class AddProducts extends Component{
    ...
    componentDidMount() {
        axios.get('http://localhost:5000/category/api/getCategory')
            .then(response => {
    ...
    render() {
        return(
            <Container maxWidth={"md"} /*style={{backgroundImage: `url(${image})`}} */>
