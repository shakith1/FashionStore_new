...
export default class ReviewTable extends Component {
    ...
    deleteReview(){
        ...
        axios.delete('/review/delete/' + this.props.obj._id)
            .then((res) => {
    ...
    render() {
        return (
            ...
            <tr>
                <td className="w-25">
                    <img src={this.props.obj.image} className="img-fluid img-thumbnail" alt="..."/>
                </td>
                ...
                <td>
                    <Link to={"/n/" + this.props.obj._id} className="btn btn-success">
                        Edit
                ...
                <td>
                    <button onClick={this.deleteReview} className="btn btn-danger">
                        Delete
